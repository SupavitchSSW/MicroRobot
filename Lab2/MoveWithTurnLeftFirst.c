...
#define baseSpeed 28 //first test with 45
#define baseSpeedCollis 20
#define blockDistance 630 //Base 625
#define jane 0.0748 //maybe work at 0.048 --> 0.058 --> 0.068 better work -->0.072 almost perfect -->0.0725 not ok -->0.0738 Perfect

#define baseFront 	20.0//check wall in func check
#define baseWall    20//check wall in func check
#define baseSpeedTurn 10
#define baseFrontCollis 8
#define wallDistance 20//field check wall
...
int position[2] = {8,8};
int degreeBlock;
int baseLeft=8; //check collis when walk
int baseRight=8 ; //check collis when walk
float degree=0;
int left_dis=0;
float eiei=1;//0.78;//
int right_dis=0;
